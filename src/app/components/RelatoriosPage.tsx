        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center gap-8">
          <AnimatedSection delay={0.1}>
            ...
            <p className="mt-6 text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
              {t({
                ...
                en: "Transparent and accessible pedagogical documentation — a living record of the work carried out with our children.",
              })}
            </p>
          </AnimatedSection>
          <AnimatedSection delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
              ...
              >
                {t({ pt: 'Ver relatórios', it: 'Vedi le relazioni', de: "Berichte ansehen", en: "View the reports" })}
              </a>
            </div>
          </AnimatedSection>
        </div>
          ...
          <AnimatedSection delay={0.1}>
            <div className="text-center mb-20">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                {t({ pt: 'Áreas de trabalho', it: 'Aree di lavoro', de: "Arbeitsbereiche", en: "Areas of work" })}
              </h2>
              <p className="text-gray-600 text-xl leading-relaxed max-w-3xl mx-auto">
                {t({
                  ...
                  en: "Choose an area to discover the reports and the careful record of the activities, discoveries and development of the children.",
                })}
              </p>
            </div>
          </AnimatedSection>
