        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <AnimatedSection delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-12 text-center">
              {t({ pt: 'Uma proposta sociointeracionista', it: 'Una proposta socio-interazionista', de: "Ein sozio-interaktionistischer Ansatz", en: "A socio-interactionist approach" })}
            </h2>
          </AnimatedSection>
              ...
              <div className="space-y-5 text-gray-600 text-lg leading-relaxed">
                ...
                <p>
                  {t({
                    ...
                    en: "Our methodology is inspired by Participatory Pedagogies and the Reggio Emilia approach, which value the child as the protagonist of learning and ensure that children learn through play, experiences, interactions and everyday discoveries.",
                  })}
                </p>
              </div>
              <div className="space-y-5 text-gray-600 text-lg leading-relaxed">
                <p>
                  {t({
                    ...
                    en: "That is why we listen carefully to their interests, ideas and needs, planning activities that respect each child's own pace and individuality. We value different forms of expression, such as drawing, painting, music, movement, language and play.",
                  })}
                </p>
                <p>
                  {t({
                    ...
                    en: "We also understand that spaces educate. That is why we organise welcoming environments rich in possibilities for exploration and learning. Investigative contexts and the atelier are important spaces for children to research, create, experiment and build knowledge in a meaningful way.",
                  })}
                </p>
                <p>
                  {t({
                    ...
                    en: "With this educational approach, we seek to offer experiences that strengthen children's autonomy, creativity, participation and overall development, helping them build a future with more opportunities, dignity and hope.",
                  })}
                </p>
              </div>
            </div>
          ...
          <AnimatedSection delay={0.3}>
            <img loading="lazy"
              src={img1}
              alt={t({ pt: 'Crianças em interação', it: 'Bambini in interazione', de: "Kinder in Interaktion", en: "Children interacting" })}
          ...
          <AnimatedSection delay={0.1}>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-4">
                {t({ pt: 'Os pilares da nossa metodologia', it: 'I pilastri della nostra metodologia', de: "Die Grundpfeiler unserer Methodik", en: "The pillars of our methodology" })}
              </h2>
              <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
                {t({
                  ...
                  en: "Every element of our work is born from an integrated vision of child development.",
                })}
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection delay={0.1}>
              <img loading="lazy"
                src={reggioImg}
                alt={t({ pt: 'Abordagem Reggio Emilia', it: 'Approccio Reggio Emilia', de: "Reggio-Emilia-Ansatz", en: "Reggio Emilia Approach" })}
            ...
            <AnimatedSection delay={0.2}>
              <div>
                <p className="text-[var(--warm-orange)] uppercase tracking-widest text-sm font-semibold mb-4">
                  {t({ pt: 'Nossa inspiração', it: 'La nostra ispirazione', de: "Unsere Inspiration", en: "Our inspiration" })}
                </p>
                <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                  {t({ pt: 'Abordagem Reggio Emilia', it: 'Approccio Reggio Emilia', de: "Reggio-Emilia-Ansatz", en: "Reggio Emilia Approach" })}
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  {t({
                    ...
                    en: "The Reggio Emilia Approach is an educational philosophy born in Italy in the 1960s, developed by Loris Malaguzzi and the communities of Reggio Emilia. Today it is internationally recognised as one of the most innovative models of early childhood education.",
                  })}
                </p>
                <p className="text-gray-600 text-lg leading-relaxed mb-10">
                  {t({
                    ...
                    en: "The Centro Nossa Senhora Aparecida does not define itself as a Reggio Emilia school, but since 2018 this approach has been a deep source of inspiration guiding its daily educational work.",
                  })}
                </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection delay={0.1} className="order-2 lg:order-1">
              <img loading="lazy"
                src={img2}
                alt={t({ pt: 'Pedagogias participativas', it: 'Pedagogie partecipative', de: "Partizipative Pädagogiken", en: "Participatory pedagogies" })}
                className="w-full rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.12)] object-cover h-80 lg:h-96"
              />
            </AnimatedSection>
            <AnimatedSection delay={0.2} className="order-1 lg:order-2">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                  {t({ pt: 'Pedagogias participativas', it: 'Pedagogie partecipative', de: "Partizipative Pädagogiken", en: "Participatory pedagogies" })}
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  {t({
                    ...
                    en: "Our practice is also inspired by Participatory Pedagogies, which encourage sensitive listening, respect for childhood and children's participation in planning and carrying out activities.",
                  })}
                </p>
          ...
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-gray-600 text-xl leading-relaxed text-center max-w-3xl mx-auto mb-16">
              {t({
                ...
                en: "The Pedagogical Exhibitions are important moments in our educational approach, as they allow us to share with families and the community the experiences, discoveries and learning the children have lived throughout the year.",
              })}
            </p>
          </AnimatedSection>
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  {t({
                    ...
                    en: "Through photos, documentation, creations, words and projects developed by the children, we make visible the learning journey of each group, valuing their efforts, achievements, curiosity and ways of thinking.",
                  })}
                </p>
                <p>
                  {t({
                    ...
                    en: "More than presenting results, the exhibitions reveal the processes lived by the children, showing how they learn, investigate, create, play and build knowledge in everyday life. They also strengthen the partnership between the nursery school and families, who come to know and value even more the experiences that are part of their children's childhood.",
                  })}
                </p>
                <p>
                  {t({
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <AnimatedSection delay={0.1}>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-16">
              {t({
                ...
                en: "Ongoing training for our teachers",
              })}
            </h2>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.3}>
            <img loading="lazy"
              src={formacaoContImg}
              alt={t({ pt: 'Formação continuada dos professores', it: 'Formazione continua degli insegnanti', de: "Fortlaufende Weiterbildung der Lehrkräfte", en: "Ongoing teacher training" })}
          ...
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-12 text-center max-w-3xl mx-auto">
              {t({
                ...
                en: "The educational work also addresses important cross-cutting themes for children's growth and for building a fairer, more aware community.",
              })}
            </p>
          </AnimatedSection>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[var(--beige)] rounded-2xl p-8 shadow-lg">
              <ul className="space-y-4 text-lg text-gray-700">
                {[
                  t({ pt: 'educação étnica e racial', it: 'educazione etnica e razziale', de: "ethnische und rassische Bildung", en: "ethnic and racial education" }),
                  t({ pt: 'educação inclusiva', it: 'educazione inclusiva', de: "inklusive Bildung", en: "inclusive education" }),
                  t({ pt: 'atenção ao género na primeira infância', it: 'attenzione al genere nella prima infanzia', de: "Sensibilisierung für Geschlechterfragen in der frühen Kindheit", en: "attention to gender in early childhood" }),
                  t({ pt: 'prevenção da violência', it: 'prevenzione della violenza', de: "Gewaltprävention", en: "violence prevention" }),
                  t({ pt: 'educação ambiental', it: 'educazione ambientale', de: "Umweltbildung", en: "environmental education" })
                ].map((item) => (
          ...
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              {t({
                ...
                en: "Our methodology comes to life every day in the spaces, relationships and activities of the nursery school. Discover how it takes shape in the Centre's daily life.",
              })}
            </p>
