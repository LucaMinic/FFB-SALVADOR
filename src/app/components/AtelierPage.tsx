    ...
    <>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center gap-8">
          <AnimatedSection delay={0.1}>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
              {t({ pt: 'Ateliê', it: 'Atelier', de: "Atelier", en: "Atelier" })}
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
              {t({
                ...
                en: "A space where children explore, investigate and express themselves through different materials, colours and languages — a place of listening, creativity and discovery.",
              })}
            </p>
          </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection delay={0.1}>
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                  {t({ pt: 'O que é o Ateliê', it: "Cos'è l'Atelier", de: "Was ist das Atelier", en: "What is the Atelier" })}
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  {t({
                    ...
                    en: "The atelier is a space for listening, creativity and relationship, inspired by the Reggio Emilia approach. It is not just an art room: it is a research workshop where children encounter materials, languages and possibilities to explore the world.",
                  })}
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  {t({
                    ...
                    en: "The atelier of the Centro Nossa Senhora Aparecida was created as a space dedicated to children's expression and to the work of the atelierista, the professional figure who animates and documents the creative experiences.",
                  })}
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.2}>
              <img loading="lazy"
                src={img1}
                alt={t({ pt: 'Ateliê criativo', it: 'Atelier creativo', de: "Kreatives Atelier", en: "Creative atelier" })}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection delay={0.1} className="order-2 lg:order-1">
              <img loading="lazy"
                src={img2}
                alt={t({ pt: 'A atelierista', it: "L'atelierista", de: "Die Atelierista", en: "The atelierista" })}
                className="w-full rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.12)] object-cover h-80 lg:h-96"
              />
            </AnimatedSection>
            <AnimatedSection delay={0.2} className="order-1 lg:order-2">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                  {t({ pt: 'A atelierista', it: "L'atelierista", de: "Die Atelierista", en: "The atelierista" })}
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  {t({
                    ...
                    en: "The atelierista is a central educational figure in the Reggio Emilia Approach. She is a professional with an artistic background who works with educators to enrich the children's experience, creating opportunities to encounter different materials and languages.",
                  })}
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  {t({
                    ...
                    en: "At the Centre, the atelierista accompanies the children's creative journeys, documents the processes, animates the atelier and collaborates with the pedagogical team in designing educational experiences.",
                  })}
                </p>
              </div>
            </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection delay={0.1}>
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                  {t({ pt: 'Os materiais como linguagem', it: 'I materiali come linguaggio', de: "Materialien als Sprache", en: "Materials as language" })}
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  {t({
                    ...
                    en: "In the atelier, materials are not just tools: they are languages. Clay, water, light, threads, fabrics, natural elements, pigments — each material offers the child a different way of thinking, feeling and creating.",
                  })}
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  {t({
                    ...
                    en: "The choice of materials is intentional and carefully curated. Each proposal is born from observing the children and their interests, creating settings that invite exploration and discovery.",
                  })}
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.2}>
              <img loading="lazy"
                src={img3}
                alt={t({ pt: 'Materiais no ateliê', it: "Materiali nell'atelier", de: "Materialien im Atelier", en: "Materials in the atelier" })}
                className="w-full rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.12)] object-cover h-80 lg:h-96"
              />
            </AnimatedSection>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection delay={0.1} className="order-2 lg:order-1">
              <img loading="lazy"
                src={img4}
                alt={t({ pt: 'Contextos investigativos', it: 'Contesti investigativi', de: "Forschungskontexte", en: "Investigative contexts" })}
                className="w-full rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.12)] object-cover h-80 lg:h-96"
              />
            </AnimatedSection>
            <AnimatedSection delay={0.2} className="order-1 lg:order-2">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
                  {t({ pt: 'Contextos investigativos', it: 'Contesti investigativi', de: "Forschungskontexte", en: "Investigative contexts" })}
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  {t({
                    ...
                    en: "Investigative contexts are pedagogical settings designed to encourage in-depth exploration of a theme or material. The child does not receive ready-made answers: they are invited to ask questions, observe, form hypotheses and build their own knowledge.",
                  })}
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  {t({
                    ...
                    en: "At the Centre, investigative contexts arise from listening to the children and are documented to make the learning journey visible to educators, families and the community.",
                  })}
                </p>
              </div>
            </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <AnimatedSection delay={0.1}>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-4">
                {t({ pt: 'O que acontece no ateliê', it: "Cosa succede nell'atelier", de: "Was im Atelier geschieht", en: "What happens in the atelier" })}
              </h2>
              <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
                {t({
                  ...
                  en: "The atelier is not a space separate from the life of the nursery school: it is an integral part of the daily educational journey.",
                })}
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: '🖌️',
                title: t({ pt: 'Expressão plástica e pictórica', it: 'Espressione plastica e pittorica', de: "Plastischer und malerischer Ausdruck", en: "Sculptural and pictorial expression" }),
                desc: t({ pt: 'Argila, pinturas, pigmentos e materiais naturais para dar forma ao pensamento', it: 'Argilla, pitture, pigmenti e materiali naturali per dare forma al pensiero', de: "Ton, Farben, Pigmente und Naturmaterialien, um dem Denken eine Form zu geben", en: "Clay, paints, pigments and natural materials to give shape to thought" })
              },
              {
                icon: '💡',
                title: t({ pt: 'Exploração da luz', it: 'Esplorazione della luce', de: "Erkundung des Lichts", en: "Exploring light" }),
                desc: t({ pt: 'Jogos de luz e sombra que estimulam a observação e a curiosidade científica', it: 'Giochi di luce e ombra che stimolano l\'osservazione e la curiosità scientifica', de: "Licht- und Schattenspiele, die die Beobachtungsgabe und die wissenschaftliche Neugier anregen", en: "Light and shadow games that stimulate observation and scientific curiosity" })
              },
              {
                icon: '🔍',
                title: t({ pt: 'Investigação de materiais', it: 'Investigazione dei materiali', de: "Erforschung der Materialien", en: "Investigating materials" }),
                desc: t({ pt: 'Descoberta das propriedades dos materiais através do tato, da observação e da experimentação', it: 'Scoperta delle proprietà dei materiali attraverso il tatto, l\'osservazione e la sperimentazione', de: "Entdeckung der Materialeigenschaften durch Tasten, Beobachten und Experimentieren", en: "Discovering the properties of materials through touch, observation and experimentation" })
              },
              {
                icon: '📖',
                title: t({ pt: 'Documentação', it: 'Documentazione', de: "Dokumentation", en: "Documentation" }),
                desc: t({ pt: 'Fotografias, registos escritos e criações que tornam visível o processo de aprendizagem', it: 'Fotografie, registrazioni scritte e creazioni che rendono visibile il processo di apprendimento', de: "Fotografien, schriftliche Aufzeichnungen und Werke, die den Lernprozess sichtbar machen", en: "Photographs, written records and creations that make the learning process visible" })
              },
              {
                icon: '🎭',
                title: t({ pt: 'Jogo simbólico e dramático', it: 'Gioco simbolico e drammatico', de: "Symbol- und Rollenspiel", en: "Symbolic and dramatic play" }),
                desc: t({ pt: 'Teatro, narração e jogo de papéis que desenvolvem a imaginação e a linguagem', it: 'Teatro, narrazione e gioco di ruolo che sviluppano l\'immaginazione e il linguaggio', de: "Theater, Erzählen und Rollenspiel, die Vorstellungskraft und Sprache entwickeln", en: "Theatre, storytelling and role play that develop imagination and language" })
              },
              {
                icon: '🌿',
                title: t({ pt: 'Elementos naturais', it: 'Elementi naturali', de: "Naturelemente", en: "Natural elements" }),
                desc: t({ pt: 'Pedras, folhas, sementes e água como materiali vivos para explorar o mundo natural', it: 'Pietre, foglie, semi e acqua come materiali vivi per esplorare il mondo naturale', de: "Steine, Blätter, Samen und Wasser als lebendige Materialien zur Erkundung der Natur", en: "Stones, leaves, seeds and water as living materials for exploring the natural world" })
              }
            ].map((item, index) => (
      ...
      <section className="bg-[var(--beige)] py-24 md:py-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <AnimatedSection delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
              {t({ pt: 'Descubra a abordagem pedagógica', it: "Scopri l'approccio pedagogico", de: "Entdecken Sie den pädagogischen Ansatz", en: "Discover the pedagogical approach" })}
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              {t({
                ...
                en: "The atelier is part of a broader educational vision, inspired by the Reggio Emilia Approach. Discover the principles that guide the Centre's daily work.",
              })}
            </p>
