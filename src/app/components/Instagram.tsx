      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-4xl md:text-5xl text-[var(--deep-blue)]">
                {t({ pt: 'Siga a Fundação Betânia dia a dia', it: 'Segui la Fundação Betânia giorno per giorno', de: "Begleiten Sie die Fundação Betânia Tag für Tag", en: "Follow Fundação Betânia day by day" })}
              </h2>
            </div>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              {t({
                ...
                en: "On Instagram we share moments of daily life, updates from the mission and small signs of what is born every day in Salvador de Bahia."
              })}
            </p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.4}>
          <div className="text-center">
            ...
            >
              <Button variant="secondary">{t({ pt: 'Ir para o perfil do Instagram', it: 'Vai al profilo Instagram', de: "Zum Instagram-Profil", en: "Go to the Instagram profile" })}</Button>
            </a>
          </div>
        </AnimatedSection>
      </div>
