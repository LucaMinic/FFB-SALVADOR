          ...
          <AnimatedSection delay={0.2}>
            <h2 className="text-4xl md:text-5xl text-[var(--deep-blue)] mb-8">
              {t({
                ...
                de: "Franziskanische Gemeinschaft von Betania",
                en: "Franciscan Fraternity of Betania"
              })}
            </h2>
            ...
            <p className="text-lg text-gray-800 leading-relaxed mb-10 font-light">
              {t({
                ...
                de: "Am Ursprung der Erfahrung der Fundação Betania ONLUS und des Centro Nossa Senhora Aparecida steht die Franziskanische Gemeinschaft von Betania.",
                en: "At the root of the experience of Fundação Betania ONLUS and the Centro Nossa Senhora Aparecida is the Franciscan Fraternity of Betania."
              })}
            </p>
            ...
            <p className="text-lg text-gray-800 leading-relaxed mb-10 font-light">
              {t({
                ...
                de: "Durch die missionarische Präsenz, das Teilen des Alltags und den Dienst an den verletzlichsten Gemeinschaften begleitet die Gemeinschaft seit Jahren einen menschlichen, pädagogischen und geistlichen Weg, der weiterhin Aufnahme, Beziehung und Hoffnung schenkt.",
                en: "Through its missionary presence, the sharing of daily life and service to the most vulnerable communities, the Fraternity has for years accompanied a human, educational and spiritual journey that continues to generate welcome, relationship and hope."
              })}
            </p>
