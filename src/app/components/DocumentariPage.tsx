  ...
  const documentaries = [
    {
      ...
      title: t({ pt: 'Entrevista ao Centro', it: 'Intervista al Centro', de: "Interview mit dem Centro" }),
      description: t({
    ...
    },
    {
      ...
      title: t({ pt: 'A visita do Presidente da República Italiana', it: 'La visita del Presidente della Repubblica Italiana', de: "Der Besuch des Präsidenten der Italienischen Republik" }),
      description: t({
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center gap-8">
          <AnimatedSection delay={0.1}>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
              {t({ pt: 'Documentários e Relatos', it: 'Documentari e Racconti', de: "Dokumentarfilme und Geschichten" })}
            </h1>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <AnimatedSection delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-8">
              {t({ pt: 'Narrar para preservar a memória', it: 'Raccontare per custodire la memoria', de: "Erzählen, um die Erinnerung zu bewahren" })}
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <AnimatedSection delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
              {t({ pt: 'Descubra a vida do Centro', it: 'Scopri la vita del Centro', de: "Entdecken Sie das Leben im Centro" })}
            </h2>
