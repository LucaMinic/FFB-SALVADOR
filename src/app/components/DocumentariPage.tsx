  ...
  const documentaries = [
    ...
    },
    {
      ...
      description: t({
        ...
        de: "Liebe Freunde, wir freuen uns, diese Erfahrung mit Ihnen zu teilen: Am Freitag, den 19. Juli 2024, hatten wir die Freude, den Präsidenten der Republik, Sergio Mattarella, bei unserer Mission in Brasilien zu empfangen. Das Staatsoberhaupt befand sich anlässlich des 150. Jahrestages der italienischen Auswanderung im Land, einer Reise, die der Begegnung mit den verschiedenen italienischen Gemeinschaften vor Ort gewidmet war. Als abschließende Station seiner Reise wählte er auch den Besuch unserer Bruderschaft und der Kita. Es war eine Erfahrung voller Emotion und großer Gnade. 💙",
        en: "Dear friends, we are happy to share this experience with you: on Friday 19 July 2024 we had the pleasure of receiving a visit from the President of the Republic, Sergio Mattarella, at our Mission in Brazil. The Head of State was in the country for the 150th anniversary of Italian emigration, a journey dedicated to meeting the various Italian communities present in the country. As the final stop of his visit, he chose to also visit our Fraternity and the nursery school. It was an experience full of emotion and great grace. 💙"
      }),
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center gap-8">
          <AnimatedSection delay={0.1}>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
              {t({ pt: 'Documentários e Relatos', it: 'Documentari e Racconti', de: "Dokumentarfilme und Geschichten", en: "Documentaries and Stories" })}
            </h1>
          ...
          <AnimatedSection delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
              ...
              >
                {t({ pt: 'Assista aos relatos', it: 'Guarda i racconti', de: "Geschichten ansehen", en: "Watch the stories" })}
              </a>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <AnimatedSection delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-8">
              {t({ pt: 'Narrar para preservar a memória', it: 'Raccontare per custodire la memoria', de: "Erzählen, um die Erinnerung zu bewahren", en: "Telling stories to preserve memory" })}
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              {t({
                ...
                de: "Im Laufe der Zeit ist das Centro Nossa Senhora Aparecida auch zu einem Ort der Begegnungen, Erzählungen und gemeinsam geteilten Geschichten geworden.",
                en: "Over time, the Centro Nossa Senhora Aparecida has also become a place of encounters, stories and shared narratives.",
              })}
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              {t({
                ...
                de: "Durch Dokumentarfilme, Zeugnisse und audiovisuelle Projekte entstehen Geschichten, die von Bildung, Beziehungen, Kultur und Alltagsleben erzählen.",
                en: "Through documentaries, testimonies and audiovisual projects, stories take shape that speak of education, relationships, culture and daily life.",
              })}
            </p>
          </AnimatedSection>
        </div>
          ...
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              {t({
                ...
                de: "Jede Geschichte entsteht aus alltäglichen Beziehungen, gemeinsamen Erfahrungen und gemeinsam erlebten Bildungswegen.",
                en: "Every story is born from daily relationships, shared experiences and educational journeys lived together.",
              })}
            </p>
