          ...
          <AnimatedSection delay={0.1}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                ...
                <span>{t({ pt: "Se você doa da Itália — clique aqui", it: "Se sostieni dall'Italia — clicca qui", de: "Wenn Sie aus Italien spenden — klicken Sie hier" })}</span>
              </a>
            </div>
          </AnimatedSection>
              ...
              <div className="space-y-8">
                ...
                <div id="sostegno-italia" className="border-l-4 border-[var(--deep-blue)] pl-6 scroll-mt-32">
                  <h4 className="text-xl text-[var(--deep-blue)] mb-4 flex items-center gap-3">
                    ...
                    {t({ pt: 'Se você doa da Itália', it: "Se sostieni dall'Italia", de: "Wenn Sie aus Italien spenden" })}
                  </h4>
                  <div className="space-y-5">
