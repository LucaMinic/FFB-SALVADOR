        ...
        <AnimatedSection>
          <div className="text-center mb-14">
            <h2 className="text-4xl md:text-5xl text-[var(--deep-blue)] mb-6">
              {t({ pt: 'Imprensa', it: 'Rassegna stampa', de: "Presseschau", en: "Press review" })}
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              {t({
                ...
                en: "Our mission has been told by some of the leading voices of Italian journalism."
              })}
            </p>
          </div>
        </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <article className="bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
              <div className="p-8">
                ...
                >
                  {t({ pt: 'Leia a matéria', it: "Leggi l'articolo", de: "Artikel lesen", en: "Read the article" })}
              ...
              <div className="p-8">
                ...
                <p className="text-base text-gray-600 leading-relaxed mb-6">
                  {t({
                    ...
                    en: "Sky TG24 reported on the inauguration of the convent in São Cristóvão, designed with sustainable architecture by the Rome-based studio Mixtura: natural ventilation, photovoltaic panels and rainwater harvesting."
                  })}
                </p>
                <a
