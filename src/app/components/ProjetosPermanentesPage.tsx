        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <AnimatedSection delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-8">
              {t({ pt: 'Projetos que fazem parte da rotina', it: 'Progetti parte della routine', de: "Projekte, die zum Alltag gehören" })}
            </h2>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--deep-blue)] mb-6">
              {t({ pt: 'Apoie nossos projetos', it: 'Sostieni i nostri progetti', de: "Unterstützen Sie unsere Projekte" })}
            </h2>
