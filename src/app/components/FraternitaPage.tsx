        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              ...
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <p>
                  {t({ pt: 'A Fraternidade Franciscana de Betânia é um Instituto de Vida Consagrada que pertence a Igreja Católica Apostólica Romana de direito diocesano composto por irmãos, tanto clérigos como leigos, e por irmãs que se consagram a Deus emitindo votos públicos de castidade, pobreza e obediência.', it: 'La Fraternità è formata da uomini e donne che si consacrano a Dio attraverso i voti di povertà, castità e obbedienza.', de: "Die Gemeinschaft besteht aus Männern und Frauen, die sich Gott durch die Gelübde der Armut, der Keuschheit und des Gehorsams weihen.", en: "The Fraternity is made up of men and women who consecrate themselves to God through the vows of poverty, chastity and obedience." })}
                </p>
                <p>
                  {t({ pt: 'O carisma da Fraternidade explicita-se na oração e no acolhimento, vividos num contexto de vida fraterna profundo.', it: "Viviamo insieme condividendo la vita quotidiana e costruendo relazioni fondate sulla fiducia, sulla semplicità e sull'ascolto. La nostra presenza è prima di tutto umana: una vita vissuta insieme che diventa segno concreto per gli altri.", de: "Wir leben zusammen, teilen den Alltag und bauen Beziehungen auf, die auf Vertrauen, Einfachheit und Zuhören gründen. Unsere Gegenwart ist vor allem menschlich: ein gemeinsam gelebtes Leben, das zu einem konkreten Zeichen für andere wird.", en: "We live together, sharing daily life and building relationships founded on trust, simplicity and listening. Our presence is above all human: a life lived together that becomes a concrete sign for others." })}
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.2}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              ...
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <h3 className="text-xl font-semibold text-[var(--deep-blue)]">
                  {t({ pt: 'O Nosso fundador', it: 'Il Nostro fondatore', de: "Unser Gründer", en: "Our founder" })}
                </h3>
                <p>
                  {t({ pt: 'O carisma e a espiritualidade do nosso Instituto encontram a sua principal inspiração na oração e na reflexão que o nosso fundador realizou sobre o texto de um manuscrito escrito e recebido por São Pio de Pietrelcina em 1959.', it: 'La spiritualità della Fraternità è mariana e francescana.', de: "Die Spiritualität der Gemeinschaft ist marianisch und franziskanisch.", en: "The Fraternity's spirituality is Marian and Franciscan." })}
                </p>
                <blockquote className="border-l-4 border-[var(--deep-blue)]/30 pl-4 italic">
                  <p>
                    {t({ pt: '"Não te dediques tão somente à atividade de Marta a ponto de esqueceres o silêncio de Maria; a Virgem Mãe que tão bem concilia um e outro ofício seja para ti doce modelo e inspiração."', it: "Si ispira alla figura di Maria e allo stile di san Francesco d'Assisi: una vita semplice, aperta agli altri, attenta ai bisogni spirituali e materiali delle persone.", de: "Sie orientiert sich an der Gestalt Marias und am Stil des heiligen Franziskus von Assisi: ein einfaches Leben, offen für andere, aufmerksam für die geistlichen und materiellen Bedürfnisse der Menschen.", en: "It is inspired by the figure of Mary and the style of Saint Francis of Assisi: a simple life, open to others, attentive to people's spiritual and material needs." })}
                  </p>
                  <footer className="text-sm not-italic text-gray-500 mt-2">
                    {t({ pt: 'São Pio, ao Padre Pancrazio', it: 'San Pio, a Padre Pancrazio', de: "Pater Pio, an Pater Pancrazio", en: "Saint Pio, to Father Pancrazio" })}
                  </footer>
                </blockquote>
                <h3 className="text-xl font-semibold text-[var(--deep-blue)] pt-2">
                  {t({ pt: 'Espiritualidade', it: 'Spiritualità', de: "Spiritualität", en: "Spirituality" })}
                </h3>
                <p>
                  {t({ pt: 'O ícone evangélico de Betânia, presente neste programa, inspira e orienta nossa vida cotidiana à luz do Evangelho. Nele encontramos um caminho de fraternidade, acolhimento, simplicidade e comunhão, vivido sob a luz e a presença materna da Bem-Aventurada Virgem Maria e segundo a simplicidade e a alegria de São Francisco de Assis. É dessa inspiração que nasce e se sustenta nossa espiritualidade, que, por isso, reconhecemos como Mariana-Franciscana.', it: 'Questa visione nasce anche da una riflessione del fondatore che invita a vivere in equilibrio tra azione e silenzio, tra servizio e contemplazione. Le case della Fraternità sono luoghi di accoglienza e relazione.', de: "Diese Vision entspringt auch einer Überlegung des Gründers, der dazu einlädt, im Gleichgewicht zwischen Handeln und Stille, zwischen Dienst und Kontemplation zu leben. Die Häuser der Gemeinschaft sind Orte der Gastfreundschaft und Begegnung.", en: "This vision also stems from a reflection by the founder, who invites us to live in balance between action and silence, between service and contemplation. The Fraternity's houses are places of welcome and relationship." })}
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.2}>
              <div className="rounded-2xl overflow-hidden shadow-lg bg-white flex items-center justify-center h-96">
                <img loading="lazy"
                  src={logoFundacaoIcon}
                  alt="Fundação Betânia Onlus"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-[var(--soft-green)] to-[#7ab89a] text-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-base leading-relaxed">
                  {t({ pt: '“A oração é o primeiro pilar do nosso carisma porque precede os outros e, num certo sentido, gera-os. A oração invoca a presença de Cristo entre nós, uma presença que constrói a fraternidade, é a intimidade de cada um com Jesus Cristo, é o alimento indispensável para manter vivo o fogo do verdadeiro amor que nos torna capazes de uma autêntica vida fraterna e de um verdadeiro acolhimento” (Padre Pancrazio Gaudioso)', it: 'La preghiera è il cuore della vita della Fraternità. È il luogo in cui nasce la relazione con Dio e si alimenta la vita fraterna.', de: "Das Gebet ist das Herz des Lebens der Gemeinschaft. Es ist der Ort, an dem die Beziehung zu Gott entsteht und das brüderliche Leben genährt wird.", en: "Prayer is the heart of the Fraternity's life. It is where the relationship with God is born and fraternal life is nourished." })}
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[var(--deep-blue)] to-[#4d6374] text-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-base leading-relaxed">
                  {t({ pt: 'A vida fraterna é o primeiro espaço de acolhimento que deve realizar-se antes de tudo em relação ao irmão e à irmã que o Senhor colocou ao nosso lado. Assim, “irmão” e “irmã” não são simplesmente um título, mas o que realmente somos e somos chamados a realizar entre nós, entre as pessoas e para a Igreja.', it: 'La vita insieme è il segno più concreto della loro vocazione. Essere fratelli e sorelle significa vivere relazioni vere, ogni giorno.', de: "Das gemeinsame Leben ist das konkreteste Zeichen ihrer Berufung. Brüder und Schwestern zu sein bedeutet, jeden Tag echte Beziehungen zu leben.", en: "Living together is the most concrete sign of their vocation. Being brothers and sisters means living real relationships, every day." })}
                </p>
              </div>
            </div>
          </AnimatedSection>
