    ...
    <div className="bg-white">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={heroImg}
            alt={t({ pt: 'Fraternidade Franciscana de Betânia', it: 'Fraternità Francescana di Betania', de: "Franziskanische Bruderschaft von Betania", en: "Franciscan Fraternity of Betania" })}
          ...
          <AnimatedSection delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="secondary" href="#intro-section" className="text-lg px-8 py-4 bg-white/10 backdrop-blur-sm border-white hover:bg-white/20">
                {t({ pt: 'Conheça a Fraternidade', it: 'Scopri la Fraternità', de: "Entdecken Sie die Bruderschaft", en: "Discover the Fraternity" })}
              </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <p>
                  {t({ pt: 'Na origem da Fundação Betania ONLUS está a Fraternidade Franciscana de Betânia, um Instituto de vida consagrada fundado em 1982 pelo padre Pancrazio Nicola Gaudioso.', it: "All'origine della Fundação Betania ONLUS c'è la Fraternità Francescana di Betania un Istituto di vita consacrata fondato nel 1982 da padre Pancrazio Nicola Gaudioso.", de: "Am Ursprung der Fundação Betania ONLUS steht die Franziskanische Bruderschaft von Betania, ein Institut geweihten Lebens, das 1982 von Pater Pancrazio Nicola Gaudioso gegründet wurde.", en: "At the origin of Fundação Betania ONLUS is the Franciscan Fraternity of Betania, an institute of consecrated life founded in 1982 by Father Pancrazio Nicola Gaudioso." })}
                </p>
                <p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              ...
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <p>
                  {t({ pt: 'A espiritualidade da Fraternidade é mariana e franciscana.', it: 'La spiritualità della Fraternità è mariana e francescana.', de: "Die Spiritualität der Bruderschaft ist marianisch und franziskanisch.", en: "The Fraternity's spirituality is Marian and Franciscan." })}
                </p>
                <p>
                ...
                <p>
                  {t({ pt: 'As casas da Fraternidade são lugares de acolhimento e relação.', it: 'Le case della Fraternità sono luoghi di accoglienza e relazione.', de: "Die Häuser der Bruderschaft sind Orte der Gastfreundschaft und Begegnung.", en: "The Fraternity's houses are places of welcome and relationship." })}
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.2}>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            ...
            <p className="text-xl text-gray-700 leading-relaxed text-center mb-10">
              {t({ pt: 'A Fraternidade está presente na Itália, Europa e Brasil, adaptando a sua presença às necessidades dos territórios.', it: 'La Fraternità è presente in Italia, Europa e Brasile, adattando la propria presenza alle esigenze dei territori.', de: "Die Bruderschaft ist in Italien, Europa und Brasilien präsent und passt ihre Präsenz den Bedürfnissen der jeweiligen Gebiete an.", en: "The Fraternity is present in Italy, Europe and Brazil, adapting its presence to the needs of each local area." })}
            </p>
            ...
            <div className="text-center">
              ...
              >
                {t({ pt: 'Conheça as Casas de Fraternidade', it: 'Scopri le Case di Fraternità', de: "Entdecken Sie die Häuser der Bruderschaft", en: "Discover the Fraternity Houses" })}
              </a>
            </div>
          </AnimatedSection>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-10 text-center max-w-3xl mx-auto">
              {t({ pt: 'Ao lado da Fraternidade Franciscana de Betânia cresceu ao longo do tempo uma realidade mais ampla: os Familiares de Betânia.', it: 'Accanto alla Fraternità Francescana di Betania è cresciuta nel tempo una realtà più ampia: i Familiari di Betania.', de: "Neben der Franziskanischen Bruderschaft von Betania ist im Laufe der Zeit eine größere Wirklichkeit gewachsen: die Angehörigen von Betania.", en: "Alongside the Franciscan Fraternity of Betania, a broader reality has grown over time: the Familiars of Betania." })}
            </p>
            <p className="text-lg text-gray-700 leading-relaxed mb-10 text-center">
              {t({ pt: 'Trata-se de pessoas que, de modos diferentes, participam da vida e do carisma da Fraternidade, partilhando o seu espírito na vida quotidiana.', it: 'Si tratta di persone che, in modi diversi, partecipano alla vita e al carisma della Fraternità, condividendone lo spirito nella vita quotidiana.', de: "Es handelt sich um Menschen, die auf unterschiedliche Weise am Leben und am Charisma der Bruderschaft teilhaben und deren Geist im Alltag mittragen.", en: "These are people who, in different ways, take part in the life and charism of the Fraternity, sharing its spirit in daily life." })}
            </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <AnimatedSection>
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed mb-10 text-center max-w-3xl mx-auto">
              <p>
                {t({ pt: 'A Fundação Betania ONLUS nasce da experiência da Fraternidade.', it: "La Fundação Betania ONLUS nasce dall'esperienza della Fraternità.", de: "Die Fundação Betania ONLUS entstand aus der Erfahrung der Bruderschaft.", en: "Fundação Betania ONLUS was born from the experience of the Fraternity." })}
              </p>
              <p>
                {t({ pt: 'A Fraternidade continua a ser o coração humano e espiritual de onde tudo tem origem.', it: 'La Fraternità continua a essere il cuore umano e spirituale da cui tutto ha origine.', de: "Die Bruderschaft bleibt das menschliche und geistliche Herz, aus dem alles seinen Ursprung nimmt.", en: "The Fraternity continues to be the human and spiritual heart from which everything originates." })}
              </p>
            </div>
            <div className="text-center">
              <a
                ...
                className="px-12 py-5 rounded-2xl transition-all duration-500 font-medium text-lg tracking-wide inline-block text-center bg-[var(--deep-blue)] text-white shadow-[0_8px_30px_rgba(93,112,130,0.3)] hover:shadow-[0_12px_40px_rgba(93,112,130,0.4)] hover:-translate-y-1 hover:bg-[#4d6374]"
              >
                {t({ pt: 'Conheça a Fraternidade Franciscana de Betânia, na Itália e no mundo', it: 'Scopri la Fraternità Francescana di Betania, in Italia e nel mondo', de: "Entdecken Sie die Franziskanische Bruderschaft von Betania in Italien und in der Welt", en: "Discover the Franciscan Fraternity of Betania, in Italy and around the world" })}
              </a>
            </div>
          </AnimatedSection>
        </div>
